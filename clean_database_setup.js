// Clean database setup - chỉ giữ destinations và admin user
// Chạy với: mongosh clean_database_setup.js

// Tạo database travelling_db
db = db.getSiblingDB('travelling_db');

print('Creating clean database setup...');
...
// Bộ dữ liệu destinations đầy đủ (29 destinations)
const destinations = [
  // === CHÂU ÂU ===
  {
    name: "Paris, France",
...
print(`Inserted ${users.length} admin user successfully`);

print('=== CLEAN DATABASE SETUP COMPLETED ===');
print(`Total Destinations: ${destinations.length}`);
print(`Total Users: ${users.length} (Admin only)`);
print(`Total Bookings: 0 (Clean for testing)`);
print(`Total Reviews: 0 (Clean for testing)`);
print(`Total Favorites: 0 (Clean for testing)`);
...
print('\n=== READY FOR TESTING ===');
print('You can now:');
print('1. Register new users through the app');
print('2. Login with real credentials');
print('3. Create bookings and reviews');
print('4. Add destinations to favorites');
print('5. Test all features with real data');
